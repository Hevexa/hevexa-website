...
@media (prefers-color-scheme: dark) {
  :root {
    ...
    --bg: #0D0E1C;
    --card-bg: #171929;
    --line: rgba(237, 238, 247, 0.13);
    --indigo: #8983DA;
    --indigo-dark: #A29CEA;
    --rose: #F28FA6;
    --accent-bg: rgba(137, 131, 218, 0.14);
...
.hero::before {
  ...
  height: 480px;
  background:
    radial-gradient(480px 280px at 22% 20%, rgba(45, 42, 110, 0.16), transparent 70%),
    radial-gradient(420px 260px at 78% 10%, rgba(178, 76, 107, 0.14), transparent 70%);
  pointer-events: none;
  z-index: -1;
}
...
.hero-mark {
  ...
  height: 68px;
  margin: 0 auto 28px;
  filter: drop-shadow(0 14px 26px rgba(45, 42, 110, 0.28));
}
...
@media (max-width: 760px) {
  ...
  .nav-toggle-input:checked ~ nav.site-nav {
    display: flex;
  }
  nav.site-nav a {
    width: 100%;
